...
function vtkOpenGLVertexArrayObject(publicAPI, model) {
  ...
  publicAPI.initialize = () => {
    console.log('触发VertexArrayObject-initialize');
  ...
  publicAPI.bind = () => {
    console.log('触发VertexArrayObject-bind==>激活');
  ...
  publicAPI.addAttributeArrayWithDivisor = (
    ...
    console.log(name, 'addAttributeArrayWithDivisor中buffer', buffer);
    // buffer.getCustomData() 可以获取到数据
    ...
    buffer.bind(); // true
    console.log('attribs.index', attribs);
    // 开启attribute变量
